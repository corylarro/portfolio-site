            ...
            <Row>
                <Col md={4}>
                    <Card className="card-project">
                        ...
                        <CardTitle tag="h5" className="text-white">Nucampsite</CardTitle>
                        <CardText className="text-white">Nucampsite is a website built collaboratively with other students in my cohort. Utilizing React, Redux and CSS.</CardText>
                        <a href="https://github.com/corylarro/nucampsite2"><i className="fa fa-github text-white fa-lg fa-fw" /></a>{' '}
                        <a><i className="fas fa-globe text-white fa-lg fa-fw" /></a>{' '}
                        </CardBody>
                    </Card>
                </Col>
            </Row>
